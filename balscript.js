...
var paddleHeight=15,paddleWidth=95,paddleX=(canvass.width-paddleWidth)/2;
    ...
    for(c=0;c<brickColumnCount;++c){
      for(r=0;r<brickRowCount;++r){
         if(bricks[c][r].status==1){
            ...
            gl.save();
            gl.translate(brickX,brickY);
            gl.shadowBlur=20;
            gl.shadowColor="black";
...
function pause(e){
        ...
        if(lives>0){   
         if(e.keyCode==32&&stopGame==false) {
            ...
            stop(); }    
        else{pause_status.src='play.png';
           pause_status.style.opacity=1;
